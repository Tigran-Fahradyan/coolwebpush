...
ActiveRecord::Schema.define(version: 2018_11_26_065421) do

  create_table "notification_data", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
    t.string "endpoint"
    t.string "p256dh_key"
    t.string "auth_key"
